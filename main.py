...
def get_args():
    ...
    parser.add_argument("--emb_file", type=str, default="data/wiki-news-300d-1M.vec")
...
def pad_sentences(sents, pad_id):
    ...
    for sent in sents:
        ...
        for i in range(curr_sent_len, max_len):
            sent.append(pad_id)
...
def main():
    ...
    #to_do
    # train_data.sort(key = len) #Increased accuracy?
